...
<div className="Disclaimer container">
    ...
    <h2>Modals</h2>
    <a href="#terms" class="btn orange modal-trigger">DISCLAIMER & PRIVACY POLICY</a>
    
    <div class="modal" id="terms">
        <div class="modal-content">
        <ul>
            <h5>Posting sensitive information</h5>
            <li>This site is public so any information you post will be available to anyone that accesses the Intent WebApp.
            </li>
<h5>Using Healer's Intent in place of Modern Medicine</h5>
...
If you have any questions about this Privacy Policy, please contact us.
    ...
    <h5>By clicking the following button you agree to the previous Conditions and Disclaimer</h5>
    <Link className="modal-close btn orange" to="/ask" >Request Healing</Link>
    <p></p>
    </div>
</div>
);
